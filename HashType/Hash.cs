    ...
    class Hash
    {
        ...
        public static void WhichType(string type)
        {
            switch (type.Length)
            {
                ...
                default: Console.WriteLine("Hash Type Not Found", "Not Found"); break;
            }
